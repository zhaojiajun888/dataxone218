...
class Aimmachine_tdtd(Publicmethods):
    """
    ...
    def getDefaultPathByMacID_tdtd_d(self):
        ...
        try:
            ...
            loggers.info("aimmachine_tdtd_pa.getDefaultPathByMacID_tdtd_d执行异常,请检查".center(60, "@"))

    # 将目标端路径存入txt
    def writepath_tdtd_d(self):
        paths = "/dataxone218/data/tdtd_mubiaoduan.txt"
        # 获取packagename,packagepath,installpath
        packagename, packagepath, installpath = self.getDefaultPathByMacID_tdtd_d()
    ...
    def des_publicSaveConf_tdtd(self):
        # 获取packagename,packagepath,installpath
        pathes = "/dataxone218/data/tdtd_mubiaoduan.txt"
        ...
        try:
            ...
            if codes == 200 and dbpshome == installpath:
                loggers.info("aimmachine_tdtd_pa.des_publicSaveConf_tdtd执行成功".center(60, "~"))
            else:
                loggers.info("aimmachine_tdtd_pa.des_publicSaveConf_tdtd执行失败".center(60, "!"))
        except Exception as e:
            loggers.info("aimmachine_tdtd_pa.des_publicSaveConf_tdtd执行异常,请检查".center(60, "@"))

    # 保存log saveFlowLogInfo
    def des_saveFlowLogInfo_tdtd(self):
        ...
        try:
            ...
            if codes == 200 and "success" == message:
                loggers.info("aimmachine_tdtd_pa.des_saveFlowLogInfo_tdtd执行成功".center(60, "~"))
            else:
                loggers.info("aimmachine_tdtd_pa.des_saveFlowLogInfo_tdtd执行失败".center(60, "!"))
        except Exception as e:
            loggers.info("aimmachine_tdtd_pa.des_saveFlowLogInfo_tdtd执行异常，请检查".center(60, "@"))

    # 再次保存 publicSaveFlowMacConfigureInfo
    def des_saveMacConfigure_tdtd(self):
        pathes = "/dataxone218/data/tdtd_mubiaoduan.txt"
        # 获取packagename,packagepath,installpath
        packagename, packagepath, installpath = Fileopera().readfilepa1(path=pathes)
        print("目标端", packagename)
        ...
        baseconfiginfo = '[{"5":"'+installpath+'","6":"$DBPS_HOME/rmp","7":"$DBPS_HOME/vcfsa","8":"$DBPS_HOME/elib","16":"'+packagepath+'","17":"'+packagename+'","18":"Linux host01 2.6.32-504.el6.x86_64 #1 SMP Wed Oct 15 04:27:16 UTC 2014 x86_64 x86_64 x86_64 GNU/Linux","19":"","30":51023,"31":"127.0.0.1","32":51024,"41":"'+ip140+'","42":"'+ip140+'","43":"22","44":"'+user140+'","45":"'+pwd140+'","46":"gsy","47":"10.0.0.211","49":1963,"50":"password","1112":"'+installpath+'"}]'
        params = {
            "flowID": self.follow_id,
            "engineID": "104",
            "moduleID": "3",
        ...
        try:
            ...
            dbpshome = newres["dataInfo"][0]["pathInfo"]["DBPS_HOME"]
            if codes == 200 and dbpshome == installpath:
                loggers.info("aimmachine_tdtd_pa.des_saveMacConfigure_tdtd执行成功".center(60,"~"))
            else:
                loggers.info("aimmachine_tdtd_pa.des_saveMacConfigure_tdtd执行失败".center(60,"!"))
        except Exception as e:
            loggers.info("aimmachine_tdtd_pa.des_saveMacConfigure_tdtd执行异常，请检查".center(60,"@"))

    # 保存 publicSaveEngineModuleDataBaseID
    def des_publicDataBaseID_tdtd(self):
        pathes = "/dataxone218/data/tdtd_mubiaoduan.txt"
        # 获取packagename,packagepath,installpath
        packagename, packagepath, installpath = Fileopera().readfilepa1(path=pathes)
        print("目标端", packagename)
        ...
        baseconfiginfo = '[{"5":"'+installpath+'","6":"$DBPS_HOME/rmp","7":"$DBPS_HOME/vcfsa","8":"$DBPS_HOME/elib","16":"'+packagepath+'","17":"'+packagename+'","18":"Linux host01 2.6.32-504.el6.x86_64 #1 SMP Wed Oct 15 04:27:16 UTC 2014 x86_64 x86_64 x86_64 GNU/Linux","19":"","30":51025,"31":"127.0.0.1","32":51026,"41":"'+ip140+'","42":"'+ip140+'","43":"22","44":"'+user140+'","45":"'+pwd140+'","46":"gsy","47":"10.0.0.211","49":1963,"50":"password","1112":"'+installpath+'"}]'
        params = {
            "flowID": self.follow_id,
            "engineID": "104",
            "moduleID": "3",
        ...
        try:
            ...
            if codes == 200:
                loggers.info("aimmachine_tdtd_pa.des_publicDataBaseID_tdtd执行成功".center(60, "~"))
            else:
                loggers.info("aimmachine_tdtd_pa.des_publicDataBaseID_tdtd执行失败".center(60, "!"))
        except Exception as e:
            loggers.info("aimmachine_tdtd_pa.des_publicDataBaseID_tdtd执行异常，请检查".center(60, "@"))

    # 保存 publicSaveFlowConfigureInfo
    def des_SaveFlowConfigure_tdtd(self):
        pathes = "/dataxone218/data/tdtd_mubiaoduan.txt"
        # 获取packagename,packagepath,installpath
        packagename, packagepath, installpath = Fileopera().readfilepa1(path=pathes)
        print("目标端", packagename)
        ...
        try:
            ...
            if codes == 200 and "suc" in message:
                loggers.info("aimmachine_tdtd_pa.des_SaveFlowConfigure_tdtd执行成功".center(60, "~"))
            else:
                loggers.info("aimmachine_tdtd_pa.des_SaveFlowConfigure_tdtd执行失败".center(60, "!"))
        except Exception as e:
            loggers.info("aimmachine_tdtd_pa.des_SaveFlowConfigure_tdtd执行异常，请检查".center(60, "@"))

    # 保存 saveModuleEngineFlowInfo
    def des_ModuleEngineFlow_tdtd(self):
        # 获取packagename,packagepath,installpath
        ...
        try:
            ...
            if codes == 200 and followid == self.follow_id:
                loggers.info("aimmachine_tdtd_pa.des_ModuleEngineFlow_tdtd执行成功".center(60, "~"))
            else:
                loggers.info("aimmachine_tdtd_pa.des_ModuleEngineFlow_tdtd执行失败".center(60, "!"))
        except Exception as e:
            loggers.info("aimmachine_tdtd_pa.des_ModuleEngineFlow_tdtd执行异常，请检查".center(60, "@"))
...
if __name__ == "__main__":
    s = Aimmachine_tdtd()
    # s.getDefaultPathByMacID_tdtd_d()
    # s.writepath_tdtd_d()
    # s.des_publicSaveConf_tdtd()
    # s.des_saveFlowLogInfo_tdtd()
    # s.des_saveMacConfigure_tdtd()
    # s.des_publicDataBaseID_tdtd()
    # s.des_SaveFlowConfigure_tdtd()
    s.des_ModuleEngineFlow_tdtd()